...
static struct module_pin_mux mmc0_pin_mux_dccv3[] = {
        ...
        {OFFSET(mcasp0_aclkx), (MODE(7) | RXACTIVE | PULLUP_EN)},/* GPIO3_14*/
        {-1},
};

static struct module_pin_mux mmc0_pin_mux_dcc[] = {
        {OFFSET(mmc0_dat3), (MODE(0) | RXACTIVE | PULLUP_EN)},  /* MMC0_DAT3 */
        {OFFSET(mmc0_dat2), (MODE(0) | RXACTIVE | PULLUP_EN)},  /* MMC0_DAT2 */
        {OFFSET(mmc0_dat1), (MODE(0) | RXACTIVE | PULLUP_EN)},  /* MMC0_DAT1 */
        {OFFSET(mmc0_dat0), (MODE(0) | RXACTIVE | PULLUP_EN)},  /* MMC0_DAT0 */
        {OFFSET(mmc0_clk), (MODE(0) | RXACTIVE | PULLUP_EN)},   /* MMC0_CLK */
        {OFFSET(mmc0_cmd), (MODE(0) | RXACTIVE | PULLUP_EN)},   /* MMC0_CMD */
        {OFFSET(ecap0_in_pwm0_out), (MODE(7) | RXACTIVE | PULLUP_EN)},/* GPIO0_7*/
        {-1},
};
...
static struct module_pin_mux mmc1_pin_mux_dcc[] = {
...
static struct module_pin_mux gpio2_pin_mux_dccv2[] = {
...
static struct module_pin_mux gpio2_pin_mux_dccv3[] = {
	{OFFSET(lcd_pclk), (MODE(7))},	/* GPIO2_24 */
	{OFFSET(lcd_ac_bias_en), (MODE(7))},	/* GPIO2_25 */
	{-1},
};
...
static struct module_pin_mux gpio_pin_mux[] = {
	...
	{OFFSET(gpmc_ad12), (MODE(7) | PULLUP_EN)},	/* GPIO1_12 */
	{OFFSET(gpmc_ad15), (MODE(7) | PULLUP_EN)},	/* GPIO1_15 */
...
{
	configure_module_pin_mux(gpio2_pin_mux_dccv2);
}

void enable_gpio_pin_mux_dccv3(void)
{
	configure_module_pin_mux(gpio2_pin_mux_dccv3);
}
	...
	/* Do board-specific muxes. */
        if(board_type == DCC_BOARD_REV2) {
                ...
                if(board_type == DCC_BOARD_REV3) {
                    configure_module_pin_mux(mmc0_pin_mux_dccv3);
                    enable_gpio_pin_mux_dccv3();
                } else {
                    configure_module_pin_mux(mmc0_pin_mux_dcc);
                    enable_gpio_pin_mux();
                }
                configure_module_pin_mux(mmc1_pin_mux_dcc);
